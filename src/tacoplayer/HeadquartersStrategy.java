...
public class HeadquartersStrategy {
    ...
    final static int MAGIC_NUM_TURNS_RUSH = 200; // turns to wait before building an anchor in rush mode
    ...
    static void runHeadquarters(RobotController rc) throws GameActionException {
        ...
        if (rc.getRoundNum() >= MAGIC_NUM_TURNS_RUSH && rc.getRoundNum() - lastAnchorRound >= MAGIC_ANCHOR_NUM_TURNS_RUSH) {
